...
Replace this section with the supported versions for `hookledger`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `hookledger` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in hookledger.
